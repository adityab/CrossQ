...
for env in 'dm_control/dog-stand-v0' 'dm_control/pendulum-swingup-v0'; do # 'dm_control/humanoid-stand-v0'; do # 'dm_control/fish-swim' 'dm_control/dog_run' 'dm_control/acrobot_swingup'; do
